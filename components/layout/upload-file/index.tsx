...
export default function UploadFile() {
  ...
  return (
    <>
      {/* Camera Icon Button */}
      <Box
        className="fixed bottom-20 right-4 z-50 bg-primary rounded-full p-2 cursor-pointer hover:bg-primary/90 transition-colors"
        onClick={handleOpen}
      ...
      >
        ...
        >
          ...
          {/* Bottom Controls */}
          <Box className="absolute bottom-0 left-0 right-0 bg-black/80 p-4 flex items-center justify-between">
            {/* Tính năng */}
            <IconButton
              onClick={() => {
